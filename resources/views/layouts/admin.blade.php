        ...
        <div class="d-flex" id="wrapper" data-aos="fade-right">
            ...
            <div class="border-right" id="sidebar-wrapper">
                <div class="sidebar-heading text-center">
                    <img src="/images/dashboard-admin-logo.png" alt="" class="my-4" style="max-width: 100px" />
                </div>
                <div class="list-group list-group-flush">
                    <a href="{{ route('admin-dashboard') }}"
                        class="list-group-item list-group-item-action">Dashboard</a>
                    <a href="/dashboard-account.html" class="list-group-item list-group-item-action">Web Logo</a>
                    <a href="/dashboard-account.html" class="list-group-item list-group-item-action">Promotion
                        Banner</a>
